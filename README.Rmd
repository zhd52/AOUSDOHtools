...
`AOUSDOHtools` is an R package designed for processing and analyzing survey data from the **All of Us Social Determinants of Health (AOUSDOH)** program. The package provides tools to calculate various health and well-being scores, such as:
- Neighborhood cohesion
- Social support
- Perceived discrimination
- Perceived stress
- Other survey-based metrics
...
This package is ideal for researchers and analysts working with social determinants of health (SDOH) survey data in the All of Us program.
