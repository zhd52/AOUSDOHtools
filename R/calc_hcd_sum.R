...
#'
#' This function creates a numeric score (range 7-35) that reflects the sum of perceived discrimination in
...
#'
#' @return A data frame with two columns: `person_id` and `hcd_sum`, where `hcd_sum`
#' represents the sum of perceived discrimination in health care. Participants who did not respond
#' to all 7 items will have an NA value for `hcd_sum`.
#'
